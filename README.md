...
|---|---|---|
| 視聴者 | 誰かが発言した | なし |
| 視聴者 | このチャンネルで初めての人が発言した | なし |
| 視聴者 | その配信で最初の発言をした | なし |
| 視聴者 | 久しぶりの人が発言した | 前の発言から空いた日数（1〜365日） |
| 視聴者 | 決まった人が発言した | Twitchのユーザー名 |
| 視聴者 | 決まった言葉を含む発言があった | 含まれる言葉（部分一致） |
...
「視聴者」の区分のメニュー項目はチャットの発言がきっかけなので、「決まった人が発言したら音を鳴らす」「合言葉が出たらアラートを出す」といった設定ができます（ユーザー名も言葉も、大文字小文字は区別しません）。来訪のしかたで絞る3項目は、次の発言に当てはまります。

| メニュー項目 | 当てはまる発言 |
|---|---|
| その配信で最初の発言をした | その配信で最初にチャットした人の1通目。同じ人の2回目以降の発言では動かず、配信が変わればまた動きます。**配信していないあいだの発言は初回と判定しません**（テスト配信や配信前の雑談のたびに動いてしまうため） |
| このチャンネルで初めての人が発言した | 視聴者の記録（`viewers`。「視聴者の記録」の節を参照）が1行もない人の1通目。常連は当てはまらないので、「初めて来てくれた人にだけ挨拶する」ができます。**この記録を始める前から来ている常連も「初めて」と扱われます**（記録がないためです。運用を始めた直後は動作を控えめにしておくことをおすすめします） |
| 久しぶりの人が発言した | 最後の発言から指定した日数（1〜365日）以上空けて発言した人の1通目。「お久しぶりです」と声をかけるのに使います。このチャンネルで初めての人には当てはまりません（空いた日数が決まらないためです） |
