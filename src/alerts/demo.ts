...
/** サンプルの出し方。イベント種別によらず同じ素材・表示時間・音量にする */
...
export const demoTriggers: readonly AlertTrigger[] = [
  { ...出し方, event: REDEMPTION, rewardId: null, message: '{user} さんが「{reward}」を交換しました' },
...
export const demoNotifications: readonly EventSubNotification[] = [
  通知(REDEMPTION, { user_name: 'たねのぶ', user_input: '', reward: { id: 'demo-reward', title: '水を飲む' } }),
  通知('channel.follow', { user_name: 'たねのぶ', followed_at: '2026-09-21T10:00:00Z' }),
  通知('channel.subscribe', { user_name: 'たねのぶ', tier: '1000', is_gift: false }),
  通知('channel.subscription.message', { user_name: 'たねのぶ', tier: '2000', cumulative_months: 12, streak_months: 3 }),
  通知('channel.raid', { from_broadcaster_user_name: 'たねのぶ', viewers: 42 }),
]
